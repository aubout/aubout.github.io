                              ...
                              for (var i = 0; i < tipuesearch_in.pages.length; i++)
                              {
                                   ...
                                   for (var f = 0; f < d_w.length; f++)
                                   {
                                        ...
                                        if (d_w[f].match('^-'))
                                        {
                                             ...
                                             if (tipuesearch_in.pages[i].title.search(pat) != -1 || tipuesearch_in.pages[i].text.search(pat) != -1 || tipuesearch_in.pages[i].text.normalize("NFD").replace(/[\u0300-\u036f]/g, '').search(pat) != -1 || tipuesearch_in.pages[i].tags.search(pat) != -1)
                                             {
                                                  score = 0;     
                                             }    
                                        }
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   {                                   
                                        ...
                                        if (found[i].desc)
                                        {
                                                  ...
                                                  if (d_w[0].normalize("NFD").replace(/[\u0300-\u036f]/g, '').normalize("NFC") == d_w[0])
                                                  {
                                                       if (/[a-zA-ZΑ-Ωα-ω]/.test(d_w[0]))
                                                       {
                                                            ...
                                                            if (s_1 > set.contextStart)
                                                            {
                                                                 ...
                                                                 var s_2 = t_1.normalize("NFD").replace(/[\u0300-\u036f]/g, '').normalize("NFC").indexOf(' ');
                                             ...
                                             if (standard)
                                             {
                                                  /* d_n = d.normalize("NFD").replace(/[\u0300-\u036f]/g, ''); */
                                                  /* d_f = d_n.split(' '); */
                                                  d_w = d.split(' ');
                                                  for (var f = 0; f < d_w.length; f++)
                                                  {
